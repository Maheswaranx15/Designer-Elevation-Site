            ...
            <div class="container">
               <div class="right_top_header">
                    <ul class="nav navbar-nav top_nav">
                        ...
                        <li><a href="#"><i class="fa fa-envelope-o"></i>info1commericial_design_architech@gmail.com></li>
                    </ul>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="index-2.html">Acheivements</a></li>
                            </ul>
                        </li>
                        <li class="dropdown submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Projects</a>
                            <ul class="dropdown-menu other_dropdwn">
                                <li><a href="about.html">Upcoming_projects</a></li>
                                <li><a href="about-2.html">Ongoing_projects</a></li>
                            </ul>
                        </li>
                        <li class="dropdown submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Designs</a>
                            <ul class="dropdown-menu other_dropdwn">
                                <li><a href="services.html">Property of design</a></li>
                                <li><a href="services-2.html">Modular kitchen</a></li>
                                <li><a href="services-2.html">Interior design</a></li>
                                <li><a href="services-2.html">Bedroom design</a></li>
                            </ul>
                        </li>
                        <li class="dropdown submenu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Product and services</a>
                            <ul class="dropdown-menu">
                                <li><a href="blog.html">Shop</a></li>
                                <li><a href="blog-2.html">Transportation</a></li>
                            </ul>
                        </li>
                          <li class="dropdown submenu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">Construction techniques</a></li>
                                <li><a href="#">Construction types</a></li>
                            </ul>
                        </li>
        ...
        <div class="container">
           <div class="row builder_all">
                <div class="col-md-3 col-sm-6 builder">
                    ...
                    <p>we are  specialises in building, not someone who is simply a handyman or general labourer. You need to choose a builder who specialises in building quality homes and has a visible and outstanding track record of doing just that.</p>
                </div>
                <div class="col-md-3 col-sm-6 builder">
                    <i class="fa fa-building" aria-hidden="true"></i>
                    <h4>We Deliver Quality</h4>
                    <p>our  management approach originally developed to help companies within the British automobile sector.</p>
                </div>
                <div class="col-md-3 col-sm-6 builder">
                    <i class="fa fa-clock-o" aria-hidden="true"></i>
                    <h4>Always On Time</h4>
                    <p>we focus on time, innovatly projects should be developed and they  are submitted in a span of time</p>
                </div>
                <div class="col-md-3 col-sm-6 builder">
                    <i class="fa fa-thumbs-up" aria-hidden="true"></i>
                    <h4>We Are Pasionate</h4>
                    <p>passion on building creates new idealogy,we create innovated designs for your buisness </p>
                </div>
           </div>
        </div>
    </section>
    ...
    <section class="about_us_area about_us_2 row">
        <div class="container">
            <div class="tittle wow fadeInUp">
                <h2>ABOUT US</h2>
                <h4>Commercial architects develop designs for commercial properties. They focus on designing plans for buildings that will be used for retail stores or other commercial purposes. While a townhouse complex may be designed by a residential architect, a shopping mall would be designed by a commercial architect.</h4>
            </div>
            <div class="row about_row">
                <div class="who_we_area col-md-7">
                    ...
                    <p>We are  professional builder is a general building work contractor who can put your whole project together. The builder will assume complete responsibility for the work contracted and give you a warranty once completed.</p>
        ...
        <div class="container">
            <div class="footer_row row">
                <div class="col-md-3 col-sm-6 footer_about">
                    ...
                    <p>Commercial architects develop designs for commercial properties. They focus on designing plans for buildings that will be used for retail stores or other commercial purposes. While a townhouse complex may be designed by a residential architect, a shopping mall would be designed by a commercial architect.</p>
                ...
                <div class="col-md-3 col-sm-6 footer_about">
                    <h2>Twitter Feed</h2>
                    <a href="#" class="twitter">construction ban hearing on 5th dec. hope for justice to the construction industry in Delhi to give relief to lakhs affected humbly request and other authorities to submit a report which is justified enough now
mygovindiaOGL_babalbaneBuilding  Building Company was founded in 1870 and is a leading global construction management firm working in sustainable building</a>
                    <a href="#" class="twitter">construction ban hearing on 5th dec. hope for justice to the construction industry in Delhi to give relief to lakhs affected humbly request and other authorities to submit a report which is justified enough now
mygovindiaOGL_babalbaneBuilding  Building Company was founded in 1870 and is a leading global construction m</a>
                </div>
                <div class="col-md-3 col-sm-6 footer_about">
                    <h2>CONTACT US</h2>
                    <address>
